...
class ProjectWorkflowSessionApi:
    ...
    def get_workflow_session_configurations(
        ...
        workflow_session_id: Annotated[
            StrictStr,
            Field(
                description="The ID of the workflow session to retrieve the configuration for"
            ),
        ],
    ...
    def get_workflow_sessions(
        ...
        """  # noqa: E501
        warnings.warn(
            "GET /api/projects/{projectId}/workflowSessions is deprecated.",
            DeprecationWarning,
        )
