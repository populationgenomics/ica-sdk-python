...
class BundleDataUnlinkingBatchApi:
    ...
    def get_bundle_data_unlinking_batch_items(
        ...
        sort: Annotated[
            Optional[StrictStr],
            Field(
                description="[only use with offset-based paging]<br>Which field to order the results by. The default order is ascending, suffix with ' desc' to sort descending (suffix ' asc' also works for ascending). Multiple values should be separated with commas. An example: \"?sort=sortAttribute1, sortAttribute2 desc\""
            ),
        ] = None,
        _request_timeout: Union[
            None,
