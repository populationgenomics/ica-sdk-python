...
class BundleToolApi:
    ...
    def get_bundle_tools(
        self,
        bundle_id: Annotated[
            StrictStr, Field(description="The ID of the bundle to get tools from")
        ],
    ...
    def get_tools_eligible_for_linking_to_bundle(
        ...
        bundle_id: Annotated[
            StrictStr,
            Field(description="The ID of the bundle to get the eligible tools for"),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def link_tool_to_bundle(
        self,
        bundle_id: Annotated[
            StrictStr, Field(description="The ID of the bundle to link the tool to")
        ],
