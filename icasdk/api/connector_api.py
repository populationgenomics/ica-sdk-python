...
class ConnectorApi:
    ...
    def create_connector(
        self,
        create_connector: Annotated[
            CreateConnector, Field(description="The connector to create.")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def create_download_rule(
        self,
        connector_id: StrictStr,
        create_download_rule: Annotated[
            CreateDownloadRule,
            Field(
                description="The target local folder where to write the data. Leading or trailing spaces are not accepted."
            ),
        ],
        _request_timeout: Union[
            None,
    ...
    def create_upload_rule(
        self,
        connector_id: StrictStr,
        create_upload_rule: Annotated[
            CreateUploadRule,
            Field(
                description="The local folder where to write the data. Leading or trailing spaces are not accepted."
            ),
        ],
        _request_timeout: Union[
            None,
    ...
    def get_connectors(
        ...
        active_only: Annotated[
            Optional[StrictBool],
            Field(
                description="When true only the active connectors will be returned. When false (default value) all connectors wil be returned."
            ),
        ] = None,
        _request_timeout: Union[
            None,
