...
class ProjectAnalysisApi:
    ...
    def abort_analysis(
        ...
        analysis_id: Annotated[
            StrictStr, Field(description="The ID of the analysis to abort")
        ],
    ...
    def create_cwl_analysis(
        ...
        """  # noqa: E501
        warnings.warn(
            "POST /api/projects/{projectId}/analysis:cwl is deprecated.",
            DeprecationWarning,
        )
    ...
    def create_cwl_analysis_with_json_input(
        self,
        project_id: StrictStr,
        create_cwl_with_json_input_analysis: Annotated[
            CreateCwlWithJsonInputAnalysis,
            Field(
                description="The following options can be used for actionOnExist:<br /><ul><li>Overwrite (default): If a file with that name already exists, it is overwritten.</li><li>Rename: If a file with that name already exists, an incremental counter is appended to the file name.</li><li>Skip: If a file with that name already exists, the new file is not saved and the data is discarded.</li></ul>"
            ),
    ...
    def _create_cwl_analysis_with_json_input_serialize(
        ...
        if "Accept" not in _header_params:
            _header_params["Accept"] = self.api_client.select_header_accept(
                ["application/problem+json", "application/vnd.illumina.v4+json"]
            )
    ...
    def create_cwl_analysis_with_structured_input(
        self,
        project_id: StrictStr,
        create_cwl_with_structured_input_analysis: Annotated[
            CreateCwlWithStructuredInputAnalysis,
            Field(
                description="The following options can be used for actionOnExist:<br /><ul><li>Overwrite (default): If a file with that name already exists, it is overwritten.</li><li>Rename: If a file with that name already exists, an incremental counter is appended to the file name.</li><li>Skip: If a file with that name already exists, the new file is not saved and the data is discarded.</li></ul>"
            ),
    ...
    def create_cwl_json_analysis(
        self,
        project_id: StrictStr,
        create_cwl_json_analysis: Annotated[
    ...
    def create_nextflow_analysis(
        self,
        project_id: StrictStr,
        create_nextflow_analysis: Annotated[
    ...
    def _create_nextflow_analysis_serialize(
        ...
        if _content_type:
            ...
            _default_content_type = self.api_client.select_header_content_type(
                ["application/vnd.illumina.v4+json", "application/vnd.illumina.v3+json"]
            )
            if _default_content_type is not None:
                _header_params["Content-Type"] = _default_content_type
    ...
    def create_nextflow_analysis_with_custom_input(
        self,
        project_id: StrictStr,
        create_nextflow_with_custom_input_analysis: Annotated[
            CreateNextflowWithCustomInputAnalysis,
            Field(
                description="The following options can be used for actionOnExist:<br /><ul><li>Overwrite (default): If a file with that name already exists, it is overwritten.</li><li>Rename: If a file with that name already exists, an incremental counter is appended to the file name.</li><li>Skip: If a file with that name already exists, the new file is not saved and the data is discarded.</li></ul>"
            ),
    ...
    def create_nextflow_json_analysis(
        self,
        project_id: StrictStr,
        create_nextflow_json_analysis: Annotated[
    ...
    def get_analyses(
        ...
        """  # noqa: E501
        warnings.warn(
            "GET /api/projects/{projectId}/analyses is deprecated.", DeprecationWarning
        )
    ...
    def get_analysis(
        ...
        project_id: StrictStr,
        analysis_id: Annotated[
            StrictStr, Field(description="The ID of the analysis to retrieve")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_analysis_inputs(
        ...
        analysis_id: Annotated[
            StrictStr,
            Field(description="The ID of the analysis to retrieve the inputs for"),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_analysis_outputs(
        ...
        analysis_id: Annotated[
            StrictStr,
            Field(description="The ID of the analysis to retrieve the outputs for"),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_analysis_reports(
        ...
        analysis_id: Annotated[
            StrictStr,
            Field(description="The ID of the analysis to retrieve the reports for"),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_raw_analysis_output(
        ...
        """  # noqa: E501
        warnings.warn(
            "GET /api/projects/{projectId}/analyses/{analysisId}/rawOutput is deprecated.",
            DeprecationWarning,
        )
