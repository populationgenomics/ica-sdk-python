...
class NotificationChannelApi:
    ...
    def create_notification_channel(
        self,
        create_notification_channel: Annotated[
            CreateNotificationChannel, Field(description="The new channel")
        ],
    ...
    def delete_notification_channel(
        ...
        channel_id: Annotated[
            StrictStr, Field(description="The ID of the notification channel to delete")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_notification_channel(
        ...
        channel_id: Annotated[
            StrictStr,
            Field(description="The ID of the notification channel to retrieve"),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def update_notification_channel(
        self,
        channel_id: Annotated[
            StrictStr, Field(description="The ID of the notification channel to update")
        ],
        notification_channel: Annotated[
            NotificationChannel, Field(description="The updated channel")
        ],
        if_match: Annotated[
            Optional[StrictStr],
            Field(
