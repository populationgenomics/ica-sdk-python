...
class StorageCredentialsApi:
    ...
    def get_storage_credential(
        self,
        storage_credential_id: Annotated[
            StrictStr, Field(description="The ID of the storage credential to retrieve")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def share_storage_credential(
        self,
        storage_credential_id: Annotated[
            StrictStr, Field(description="The ID of the storage credential to share")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
