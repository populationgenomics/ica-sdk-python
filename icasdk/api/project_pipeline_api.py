...
class ProjectPipelineApi:
    ...
    def create_additional_project_pipeline_file(
        ...
        pipeline_id: Annotated[
            StrictStr,
            Field(description="The ID of the project pipeline to create a file for"),
        ],
    ...
    def create_cwl_json_pipeline(
        ...
        workflow_cwl_file: Annotated[
            Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
            Field(description="The CWL workflow file."),
        ],
        input_form_file: Annotated[
            Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
            Field(description="The JSON based input form."),
        ],
        analysis_storage_id: Annotated[
            UUID, Field(description="The id of the storage to use for the pipeline.")
        ],
        tool_cwl_files: Optional[
            List[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]]
        ] = None,
        on_render_file: Annotated[
        ...
        on_submit_file: Annotated[
            Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]],
            Field(
                description="A file that will submit the current state of the input form."
            ),
        ] = None,
        other_input_form_files: Optional[
            List[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]]
        ] = None,
        metadata_model_file: Annotated[
            Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]],
            Field(
                description="The metadata model json file(contents can be retrieved from the controlplane)."
            ),
        ] = None,
        links: Optional[Links] = None,
        version_comment: Optional[StrictStr] = None,
        categories: Optional[
            Annotated[List[Optional[StrictStr]], Field(min_length=1, max_length=4000)]
        ] = None,
        html_documentation: Optional[StrictStr] = None,
        proprietary: Annotated[
            Optional[StrictBool],
            Field(
    ...
    def create_nextflow_json_pipeline(
        ...
        main_nextflow_file: Annotated[
            Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
            Field(description="The main Nextflow file."),
        ],
        input_form_file: Annotated[
            Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
            Field(description="The JSON based input form."),
        ...
        pipeline_language_version_id: Annotated[
            Optional[UUID],
            Field(
                description="The id of the Nextflow version to use for the pipeline."
            ),
        ] = None,
        nextflow_config_file: Annotated[
            Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]],
            Field(description="The Nextflow config file."),
        ] = None,
        other_nextflow_files: Optional[
            List[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]]
        ] = None,
        on_render_file: Annotated[
            Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]],
    ...
    def _create_nextflow_json_pipeline_serialize(
        ...
        if pipeline_language_version_id is not None:
            _form_params.append(
                ("pipelineLanguageVersionId", pipeline_language_version_id)
            )
        if description is not None:
            _form_params.append(("description", description))
    ...
    def delete_project_pipeline_file(
        ...
        pipeline_id: Annotated[
            StrictStr,
            Field(description="The ID of the project pipeline to delete a file for"),
        ],
        file_id: Annotated[UUID, Field(description="The ID of the pipeline file")],
        _request_timeout: Union[
            None,
    ...
    def download_additional_file_content(
        ...
        pipeline_id: Annotated[
            StrictStr,
            Field(
                description="The ID of the project pipeline to retrieve the additional file for"
            ),
        ],
    ...
    def download_input_form_file_content(
        ...
        pipeline_id: Annotated[
            StrictStr,
            Field(
                description="The ID of the project pipeline to retrieve the input form file for"
            ),
        ],
        _request_timeout: Union[
            None,
    ...
    def download_on_render_file_content(
        ...
        pipeline_id: Annotated[
            StrictStr,
            Field(
                description="The ID of the project pipeline to retrieve the onRender file for"
            ),
        ],
        _request_timeout: Union[
            None,
    ...
    def download_on_submit_file_content(
        ...
        pipeline_id: Annotated[
            StrictStr,
            Field(
                description="The ID of the project pipeline to retrieve the onSubmit file for"
            ),
        ],
        _request_timeout: Union[
            None,
    ...
    def download_project_pipeline_file_content(
        ...
        pipeline_id: Annotated[
            StrictStr,
            Field(description="The ID of the project pipeline to retrieve files for"),
        ],
        file_id: Annotated[UUID, Field(description="The ID of the pipeline file")],
        _request_timeout: Union[
            None,
    ...
    def get_project_pipeline(
        ...
        project_id: StrictStr,
        pipeline_id: Annotated[
            StrictStr, Field(description="The ID of the project pipeline to retrieve")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_project_pipeline_cwl_git_config(
        ...
        pipeline_id: Annotated[
            StrictStr,
            Field(
                description="The ID of the project pipeline to retrieve the git config for"
            ),
        ],
        _request_timeout: Union[
            None,
    ...
    def get_project_pipeline_html_documentation(
        ...
        pipeline_id: Annotated[
            StrictStr,
            Field(
                description="The ID of the project pipeline to retrieve HTML documentation from"
            ),
        ],
        _request_timeout: Union[
            None,
    ...
    def get_project_pipeline_reference_sets(
        ...
        pipeline_id: Annotated[
            StrictStr,
            Field(description="The ID of the pipeline to retrieve reference sets for"),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_project_pipelines(
        ...
        project_id: Annotated[
            StrictStr,
            Field(description="The ID of the project to retrieve pipelines for"),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def update_additional_file(
        ...
        pipeline_id: Annotated[
            StrictStr,
            Field(
                description="The ID of the project pipeline to update the additional file for"
            ),
        ],
        file_id: Annotated[UUID, Field(description="The ID of the additional file")],
        content: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
    ...
    def update_cwl_git_config(
        ...
        pipeline_id: Annotated[
            StrictStr,
            Field(
                description="The ID of the project pipeline for which to update the git config."
            ),
        ],
    ...
    def update_general_attributes_project_pipeline(
        ...
        project_id: StrictStr,
        pipeline_id: Annotated[
            StrictStr, Field(description="The ID of the project pipeline to update")
        ],
    ...
    def update_input_form_file(
        ...
        pipeline_id: Annotated[
            StrictStr,
            Field(description="The ID of the project pipeline to update a file for"),
        ],
        content: Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]],
        _request_timeout: Union[
            None,
