...
class EventLogApi:
    ...
    def get_event_logs(
        ...
        code_filter_type: Annotated[
            Optional[StrictStr], Field(description="Code filter type")
        ] = None,
        ...
        rows: Annotated[
            Optional[StrictInt],
            Field(
                description="Amount of rows to fetch (chronologically oldest first). Maximum 250. Defaults to 250"
            ),
        ] = None,
    ...
    def _search_event_logs_serialize(
        ...
        if _content_type:
            ...
            _default_content_type = self.api_client.select_header_content_type(
                ["application/vnd.illumina.v4+json", "application/json"]
            )
