...
class EntitledBundleApi:
    ...
    def accept_terms_of_use_entitled_bundle(
        self,
        entitled_bundle_id: Annotated[
            StrictStr,
            Field(
                description="The ID of the entitled bundle where the terms of use are accepted of."
            ),
        ],
    ...
    def get_entitled_bundle(
        self,
        entitled_bundle_id: Annotated[
            StrictStr, Field(description="The ID of the entitled bundle to retrieve")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_entitled_bundle_terms_of_use_acceptance(
        ...
        entitled_bundle_id: Annotated[
            StrictStr,
            Field(
                description="The ID of the entitled bundle of the terms of use acceptance records."
            ),
        ],
        _request_timeout: Union[
            None,
