...
class ProjectSampleApi:
    ...
    def add_metadata_model_to_sample(
        ...
        metadata_model_id: Annotated[
            StrictStr, Field(description="The ID of the metadata model")
        ],
        ...
        """  # noqa: E501
        warnings.warn(
            "POST /api/projects/{projectId}/samples/{sampleId}/metadata/{metadataModelId} is deprecated.",
            DeprecationWarning,
        )
    ...
    def get_project_sample_analyses(
        ...
        sample_id: Annotated[StrictStr, Field(description="The ID of the sample")],
        reference: Annotated[
            Optional[StrictStr], Field(description="The reference to filter on.")
        ] = None,
        userreference: Annotated[
            Optional[StrictStr], Field(description="The user-reference to filter on.")
        ] = None,
        status: Annotated[
            Optional[StrictStr], Field(description="The status to filter on.")
        ] = None,
        usertag: Annotated[
            Optional[StrictStr], Field(description="The user-tags to filter on.")
        ] = None,
        technicaltag: Annotated[
            Optional[StrictStr], Field(description="The technical-tags to filter on.")
        ] = None,
        referencetag: Annotated[
            Optional[StrictStr],
            Field(description="The reference-data-tags to filter on."),
        ] = None,
        ...
        """  # noqa: E501
        warnings.warn(
            "GET /api/projects/{projectId}/samples/{sampleId}/analyses is deprecated.",
            DeprecationWarning,
        )
    ...
    def get_sample_data_list(
        ...
        project_id: StrictStr,
        sample_id: Annotated[
            StrictStr, Field(description="The ID of the sample to retrieve data for")
        ],
        full_text: Annotated[
            Optional[StrictStr],
    ...
    def unlink_data_from_sample(
        ...
        sample_id: Annotated[StrictStr, Field(description="The ID of the sample")],
        data_id: Annotated[
            StrictStr, Field(description="The ID of the data to unlink")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
