...
class BundleDataApi:
    ...
    def get_bundle_data(
        ...
        status: Annotated[
            Optional[StrictStr], Field(description="The statuses to filter on.")
        ] = None,
        format_id: Annotated[
            Optional[StrictStr],
        ...
        run_input_tag_match_mode: Annotated[
            Optional[StrictStr], Field(description="How the runInputTags are filtered.")
        ] = None,
        ...
        not_linked_to_sample: Annotated[
            Optional[StrictStr],
            Field(
                description="When set to true only date that is unlinked to a sample will be returned.  This filter implies a filter of type File."
            ),
        ] = None,
