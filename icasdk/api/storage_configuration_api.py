...
class StorageConfigurationApi:
    ...
    def get_storage_configuration(
        self,
        storage_configuration_id: Annotated[
            StrictStr,
            Field(description="The ID of the storage configuration to retrieve"),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def share_storage_configuration(
        self,
        storage_configuration_id: Annotated[
            StrictStr, Field(description="The ID of the storage configuration to share")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def validate_storage_configuration(
        ...
        storage_configuration_id: Annotated[
            StrictStr,
            Field(description="The ID of the storage configuration to validate"),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
