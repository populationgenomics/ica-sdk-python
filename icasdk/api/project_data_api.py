...
from icasdk.api_client import ApiClient, RequestSerialized
...
class ProjectDataApi:
    ...
    def _add_secondary_data_serialize(
        ...
        if "Accept" not in _header_params:
            _header_params["Accept"] = self.api_client.select_header_accept(
                ["application/problem+json", "application/vnd.illumina.v3+json"]
            )

        # authentication setting
        _auth_settings: List[str] = ["JwtAuth", "ApiKeyAuth"]
    ...
    def complete_folder_upload_session(
        ...
        complete_folder_upload_session: Annotated[
    ...
    def _complete_folder_upload_session_serialize(
        ...
        if _content_type:
            ...
            _default_content_type = self.api_client.select_header_content_type(
                ["application/vnd.illumina.v3+json", "application/json"]
            )
    ...
    def create_data_in_project(
        ...
        """  # noqa: E501
        warnings.warn(
            "POST /api/projects/{projectId}/data is deprecated.", DeprecationWarning
        )
    ...
    def create_file(
        self,
        project_id: StrictStr,
        create_file_data: Annotated[
            CreateFileData, Field(description="The file to create.")
        ],
        idempotency_key: Annotated[
            Optional[Annotated[str, Field(strict=True, max_length=255)]],
            Field(
    ...
    def create_file_with_temporary_credentials(
        self,
        project_id: StrictStr,
        create_file_and_temporary_credentials: Annotated[
            CreateFileAndTemporaryCredentials, Field(description="The data to create.")
        ],
        idempotency_key: Annotated[
            Optional[Annotated[str, Field(strict=True, max_length=255)]],
            Field(
    ...
    def create_file_with_upload_url(
        self,
        project_id: StrictStr,
        create_file_and_upload_url: Annotated[
            CreateFileAndUploadUrl, Field(description="The data to create.")
        ],
        idempotency_key: Annotated[
            Optional[Annotated[str, Field(strict=True, max_length=255)]],
            Field(
    ...
    def create_folder(
        ...
        create_folder: Annotated[
            CreateFolder, Field(description="The folder to create.")
        ],
        idempotency_key: Annotated[
            Optional[Annotated[str, Field(strict=True, max_length=255)]],
            Field(
    ...
    def create_folder_upload_session(
        ...
        project_id: StrictStr,
        data_id: StrictStr,
        create_temporary_credentials: Annotated[
            Optional[CreateTemporaryCredentials],
            Field(description="Temporary credentials request options."),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def create_folder_with_temporary_credentials(
        self,
        project_id: StrictStr,
        create_folder_and_temporary_credentials: Annotated[
            CreateFolderAndTemporaryCredentials,
            Field(description="The data to create."),
        ],
        idempotency_key: Annotated[
            Optional[Annotated[str, Field(strict=True, max_length=255)]],
            Field(
    ...
    def create_non_indexed_folder(
        self,
        project_id: StrictStr,
        create_non_indexed_folder: Annotated[
            CreateNonIndexedFolder,
            Field(description="The non indexed folder to create."),
        ],
        idempotency_key: Annotated[
            Optional[Annotated[str, Field(strict=True, max_length=255)]],
            Field(
    ...
    def get_data_eligible_for_linking(
        ...
        full_text: Annotated[
            Optional[StrictStr],
            Field(description="To search through multiple fields of data."),
        ] = None,
        id: Annotated[
            Optional[List[StrictStr]],
            Field(description="The ids to filter on. This will always match exact."),
        ] = None,
        filename: Annotated[
            Optional[List[StrictStr]],
            Field(
                description="The filenames to filter on. The filenameMatchMode-parameter determines how the filtering is done."
            ),
        ] = None,
        filename_match_mode: Annotated[
            Optional[StrictStr], Field(description="How the filenames are filtered. ")
        ] = None,
        file_path: Annotated[
            Optional[List[StrictStr]],
            Field(description="The paths of the files to filter on."),
        ] = None,
        file_path_match_mode: Annotated[
            Optional[StrictStr],
            Field(
                description="How the file paths are filtered:   - STARTS_WITH_CASE_INSENSITIVE: Filters the file path to start with the value of the 'filePath' parameter, regardless of upper/lower casing. This allows e.g. listing all data in a folder and all it's sub-folders (recursively).  - FULL_CASE_INSENSITIVE: Filters the file path to fully match the value of the 'filePath' parameter, regardless of upper/lower casing. Note that this can result in multiple results if e.g. two files exist with the same filename but different casing (abc.txt and ABC.txt)."
            ),
        ] = None,
        status: Annotated[
            Optional[List[StrictStr]], Field(description="The statuses to filter on.")
        ] = None,
        format_id: Annotated[
            Optional[List[StrictStr]],
            Field(description="The IDs of the formats to filter on."),
        ] = None,
        format_code: Annotated[
            Optional[List[StrictStr]],
            Field(description="The codes of the formats to filter on."),
        ] = None,
        type: Annotated[
            Optional[StrictStr], Field(description="The type to filter on.")
        ] = None,
        parent_folder_id: Annotated[
            Optional[List[StrictStr]],
            Field(
                description="The IDs of parents folders to filter on. Lists all files and folders within the folder for the given ID, non-recursively."
            ),
        ] = None,
        ...
        creation_date_after: Annotated[
            Optional[datetime],
            Field(
                description="The date after which the data is created. Format: yyyy-MM-dd'T'HH:mm:ss'Z' eg: 2021-01-30T08:30:00Z"
            ),
        ] = None,
        creation_date_before: Annotated[
            Optional[datetime],
            Field(
                description="The date before which the data is created. Format: yyyy-MM-dd'T'HH:mm:ss'Z' eg: 2021-01-30T08:30:00Z"
            ),
        ] = None,
        status_date_after: Annotated[
            Optional[datetime],
            Field(
                description="The date after which the status has been updated. Format: yyyy-MM-dd'T'HH:mm:ss'Z' eg: 2021-01-30T08:30:00Z"
            ),
        ] = None,
        status_date_before: Annotated[
            Optional[datetime],
            Field(
                description="The date before which the status has been updated. Format: yyyy-MM-dd'T'HH:mm:ss'Z' eg: 2021-01-30T08:30:00Z"
            ),
        ] = None,
        user_tag: Annotated[
            Optional[List[StrictStr]],
            Field(
                description="The usertags to filter on. The userTagMatchMode-parameter determines how the filtering is done."
            ),
        ] = None,
        user_tag_match_mode: Annotated[
            Optional[StrictStr], Field(description="How the usertags are filtered. ")
        ] = None,
        run_input_tag: Annotated[
            Optional[List[StrictStr]],
            Field(
                description="The runInputTags to filter on. The runInputTagMatchMode-parameter determines how the filtering is done."
            ),
        ] = None,
        run_input_tag_match_mode: Annotated[
            Optional[StrictStr],
            Field(description="How the runInputTags are filtered. "),
        ] = None,
        run_output_tag: Annotated[
            Optional[List[StrictStr]],
            Field(
                description="The runOutputTags to filter on. The runOutputTagMatchMode-parameter determines how the filtering is done."
            ),
        ] = None,
        run_output_tag_match_mode: Annotated[
            Optional[StrictStr],
            Field(description="How the runOutputTags are filtered. "),
        ] = None,
        connector_tag: Annotated[
            Optional[List[StrictStr]],
            Field(
                description="The connectorTags to filter on. The connectorTagMatchMode-parameter determines how the filtering is done."
            ),
        ] = None,
        connector_tag_match_mode: Annotated[
            Optional[StrictStr],
            Field(description="How the connectorTags are filtered. "),
        ] = None,
        technical_tag: Annotated[
            Optional[List[StrictStr]],
            Field(
                description="The technicalTags to filter on. The techTagMatchMode-parameter determines how the filtering is done."
            ),
        ] = None,
        technical_tag_match_mode: Annotated[
            Optional[StrictStr],
            Field(description="How the technicalTags are filtered. "),
        ] = None,
        not_in_run: Annotated[
            Optional[StrictBool],
            Field(
                description="When set to true, the data will be filtered on data which is not used in a run."
            ),
        ] = None,
        not_linked_to_sample: Annotated[
            Optional[StrictBool],
            Field(
                description="When set to true only data that is unlinked to a sample will be returned. This filter implies a filter of type File."
            ),
        ] = None,
        instrument_run_id: Annotated[
            Optional[List[StrictStr]],
            Field(
        ...
        page_offset: Annotated[
            Optional[StrictStr],
            Field(
                description="[only use with offset-based paging]<br>The amount of rows to skip in the result. Ideally this is a multiple of the size parameter. Offset-based pagination has a result limit of 200K rows and does not guarantee unique results across pages"
            ),
        ] = None,
        page_token: Annotated[
            Optional[StrictStr],
            Field(
                description="[only use with cursor-based paging]<br>The cursor to get subsequent results. The value to use is returned in the result when using cursor-based pagination. Cursor-based pagination guarantees complete and unique results across all pages."
            ),
        ] = None,
        page_size: Annotated[
            Optional[StrictStr],
            Field(
                description="[can be used with both offset- and cursor-based paging]<br>The amount of rows to return. Use in combination with the offset (when using offset-based pagination) or cursor (when using cursor-based pagination) parameter to get subsequent results"
            ),
        ] = None,
        sort: Annotated[
            Optional[StrictStr],
            Field(
                description="[only use with offset-based paging]<br>Which field to order the results by. The default order is ascending, suffix with ' desc' to sort descending (suffix ' asc' also works for ascending). Multiple values should be separated with commas. An example: \"?sort=sortAttribute1, sortAttribute2 desc\"  The attributes for which sorting is supported: - timeCreated - timeModified - name - path - fileSizeInBytes - status - format - dataType - willBeArchivedAt - willBeDeletedAt"
            ),
        ] = None,
        _request_timeout: Union[
            None,
    ...
    def get_project_data_list(
        ...
        non_indexed_folders: Annotated[
            Optional[StrictBool], Field(description="To filter on non-indexed folders.")
        ] = None,
        parent_folder_id: Annotated[
            Optional[List[StrictStr]],
            Field(
        ...
        owning_project_id: Annotated[
            Optional[List[StrictStr]],
            Field(description="The owning project ID to filter on."),
        ] = None,
        page_offset: Annotated[
            Optional[StrictStr],
            Field(
    ...
    def update_project_data(
        ...
        project_data: Annotated[
            ProjectData, Field(description="The updated project data.")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
