...
class ProjectNotificationSubscriptionsApi:
    ...
    def create_notification_subscription(
        ...
        create_notification_subscription: Annotated[
            CreateNotificationSubscription, Field(description="The new subscription")
        ],
    ...
    def delete_notification_subscription(
        ...
        subscription_id: Annotated[
            StrictStr,
            Field(description="The ID of the notification subscription to delete"),
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_notification_subscription(
        ...
        project_id: Annotated[StrictStr, Field(description="The ID of the project")],
        subscription_id: Annotated[
            StrictStr, Field(description="The ID of the notification subscription")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def update_notification_subscription(
        ...
        subscription_id: Annotated[
            StrictStr,
            Field(description="The ID of the notification subscription to update"),
        ],
        notification_subscription: Annotated[
            NotificationSubscription, Field(description="The updated subscription")
        ],
        if_match: Annotated[
            Optional[StrictStr],
            Field(
