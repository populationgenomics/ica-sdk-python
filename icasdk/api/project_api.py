...
class ProjectApi:
    ...
    def get_projects(
        ...
        user_tags: Annotated[
            Optional[List[StrictStr]], Field(description="User tags to filter on")
        ] = None,
        technical_tags: Annotated[
            Optional[List[StrictStr]], Field(description="Technical tags to filter on")
        ] = None,
        include_hidden_projects: Annotated[
            Optional[StrictBool], Field(description="Include hidden projects.")
        ] = None,
        region: Annotated[
            Optional[StrictStr], Field(description="The ID of the region to filter on.")
        ] = None,
        workgroups: Annotated[
            Optional[List[StrictStr]], Field(description="Workgroup IDs to filter on")
        ] = None,
