...
class StorageBundle(BaseModel):
    ...
    bundle_name: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = (
        Field(description="The name of the storage bundle", alias="bundleName")
    )
    entitlement_name: Annotated[
        str, Field(min_length=1, strict=True, max_length=255)
    ] = Field(description="The name of the parent entitlement", alias="entitlementName")
    region: Region
