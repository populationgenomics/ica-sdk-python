...
class NotificationSubscription(BaseModel):
    ...
    event_code: Annotated[str, Field(min_length=1, strict=True, max_length=20)] = Field(
        description="The event code to subscribe to", alias="eventCode"
    )
    payload_version: Optional[StrictStr] = Field(
        default=None,
        description="The version of the notification event payload in case multiple versions exist. For analysis events possible values are [V3,V4]",
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.filter_expression is None
            and "filter_expression" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "notificationChannel": NotificationChannel.from_dict(
                    obj["notificationChannel"]
                )
                if obj.get("notificationChannel") is not None
                else None,
