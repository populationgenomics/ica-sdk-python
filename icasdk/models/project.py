...
class Project(BaseModel):
    ...
    urn: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2000)]] = (
        Field(
            default=None,
            description="The URN of the project. The format is urn:ilmn:ica:\\<type of the object\\>:\\<ID of the object\\>#\\<optional human readable hint representing the object\\>. The hint can be omitted, in that case the hashtag (#) must also be omitted.",
        )
    )
    ...
    base_enabled: Optional[StrictBool] = Field(
        default=None,
        description="Indicates whether the project is base enabled.",
        alias="baseEnabled",
    )
    short_description: Optional[
        Annotated[str, Field(min_length=1, strict=True, max_length=4000)]
    ] = Field(default=None, alias="shortDescription")
    information: Optional[StrictStr] = Field(
        default=None,
        description="Information about the project. Note that the value of this field can be arbitrary large.",
    )
    region: Region
    billing_mode: StrictStr = Field(
        description="The billing mode of the project. It determines who pays for the costs linked to the project.",
        alias="billingMode",
    )
    data_sharing_enabled: Optional[StrictBool] = Field(
        default=None,
        description="Indicates whether the Data and Samples created in this Project can be linked to other Projects.",
        alias="dataSharingEnabled",
    )
    tags: ProjectTag
    storage_bundle: Optional[StorageBundle] = Field(default=None, alias="storageBundle")
    self_managed_storage_configuration: Optional[StorageConfiguration] = Field(
        default=None, alias="selfManagedStorageConfiguration"
    )
    analysis_priority: Optional[StrictStr] = Field(
        default=None,
        description="Indicates the priority given to a project and its analyses within a single tenant. Note that for a PUT call, when not providing a value for this attribute (null value or absent attribute), the persisted value will not change.",
        alias="analysisPriority",
    )
    metadata_model: Optional[MetadataModel] = Field(default=None, alias="metadataModel")
    application: Optional[Application] = None
    project_owner: Optional[UUID] = Field(
        default=None,
        description="projectOwner is the current project owner, ownerId is the original project creator. These can be different because you can transfer ownership of a project.",
        alias="projectOwner",
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.self_managed_storage_configuration:
            _dict["selfManagedStorageConfiguration"] = (
                self.self_managed_storage_configuration.to_dict()
            )
        ...
        if (
            ...
            and "short_description" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.data_sharing_enabled is None
            and "data_sharing_enabled" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.analysis_priority is None
            and "analysis_priority" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "tags": ProjectTag.from_dict(obj["tags"])
                if obj.get("tags") is not None
                else None,
                "storageBundle": StorageBundle.from_dict(obj["storageBundle"])
                if obj.get("storageBundle") is not None
                else None,
                "selfManagedStorageConfiguration": StorageConfiguration.from_dict(
                    obj["selfManagedStorageConfiguration"]
                )
                if obj.get("selfManagedStorageConfiguration") is not None
                else None,
                "analysisPriority": obj.get("analysisPriority"),
                "metadataModel": MetadataModel.from_dict(obj["metadataModel"])
                if obj.get("metadataModel") is not None
                else None,
