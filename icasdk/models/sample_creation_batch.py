...
class SampleCreationBatch(BaseModel):
    ...
    sequencing_run_id: Optional[UUID] = Field(
        default=None,
        description="The sequencingRunId to link to all created samples and linked data",
        alias="sequencingRunId",
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.sequencing_run_id is None
            and "sequencing_run_id" in self.model_fields_set
        ):
