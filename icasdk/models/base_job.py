...
class BaseJob(BaseModel):
    ...
    description: Optional[StrictStr] = Field(
        default=None, description="A short description of the base job"
    )
    ...
    overall_duration: Optional[StrictInt] = Field(
        default=None,
        description="The duration of the job expressed in milliseconds",
        alias="overallDuration",
    )
    details: Optional[StrictStr] = Field(
        default=None, description="Detailed description of the job"
    )
    bytes_billed: Optional[StrictInt] = Field(
        default=None, description="Bytes billed", alias="bytesBilled"
    )
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('COPYTABLE', 'EXPORTTABLE', 'CREATETABLE', 'EXECUTEQUERY', 'LOADDATA', 'PREPAREDATA')"
            )
        return value
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(
            ["CREATED", "SUCCEEDED", "FAILED", "PENDING", "INPROGRESS", "ABORTED"]
        ):
            raise ValueError(
                "must be one of enum values ('CREATED', 'SUCCEEDED', 'FAILED', 'PENDING', 'INPROGRESS', 'ABORTED')"
            )
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.overall_duration is None
            and "overall_duration" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "table": ProjectBaseTable.from_dict(obj["table"])
