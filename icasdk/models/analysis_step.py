...
class AnalysisStep(BaseModel):
    ...
    queue_date: Optional[datetime] = Field(
        default=None, description="When the analysis step was queued", alias="queueDate"
    )
    ...
    end_date: Optional[datetime] = Field(
        default=None, description="When the analysis step was finished", alias="endDate"
    )
    technical: StrictBool = Field(
        description="Indicates which kind of step was executed"
    )
    logs: AnalysisStepLogs
    exit_code: Optional[StrictInt] = Field(
        default=None, description="The exit code of the analysis step", alias="exitCode"
    )
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(
            ["FAILED", "DONE", "RUNNING", "INTERRUPTED", "ABORTED", "WAITING"]
        ):
            raise ValueError(
                "must be one of enum values ('FAILED', 'DONE', 'RUNNING', 'INTERRUPTED', 'ABORTED', 'WAITING')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "logs": AnalysisStepLogs.from_dict(obj["logs"])
