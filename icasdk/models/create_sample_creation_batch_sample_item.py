...
class CreateSampleCreationBatchSampleItem(BaseModel):
    ...
    data_to_link: Optional[List[Optional[CreateSampleCreationBatchDataItem]]] = Field(
        default=None,
        description="The data to be linked to the new sample.",
        alias="dataToLink",
    )
    complete_sample: StrictBool = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "sampleToCreate": CreateSample.from_dict(obj["sampleToCreate"])
                if obj.get("sampleToCreate") is not None
                else None,
                "dataToLink": [
                    CreateSampleCreationBatchDataItem.from_dict(_item)
                    for _item in obj["dataToLink"]
                ]
                if obj.get("dataToLink") is not None
                else None,
