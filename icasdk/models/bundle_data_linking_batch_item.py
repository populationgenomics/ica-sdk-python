...
class BundleDataLinkingBatchItem(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "request": BundleDataLinkingBatchItemRequest.from_dict(obj["request"])
                if obj.get("request") is not None
                else None,
                "processing": BundleDataLinkingBatchItemProcessing.from_dict(
                    obj["processing"]
                )
                if obj.get("processing") is not None
                else None,
                "bundleData": BundleData.from_dict(obj["bundleData"])
                if obj.get("bundleData") is not None
                else None,
            }
        )
        return _obj
