...
class UpdateMetadataFieldGroup(BaseModel):
    ...
    field_name: Optional[StrictStr] = Field(
        default=None,
        description="The field name to be updated. Either the field ID or field name is required.",
        alias="fieldName",
    )
    index: StrictInt = Field(description="Which metadata row index to update")
    update_single_metadata_fields: List[UpdateSingleMetadataField] = Field(
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "fieldId": FieldId.from_dict(obj["fieldId"])
                if obj.get("fieldId") is not None
                else None,
