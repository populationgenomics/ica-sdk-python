...
class Job(BaseModel):
    ...
    id: UUID
    status: StrictStr
    additional_status_information: Optional[StrictStr] = Field(
        default=None,
        description="Additional information regarding the status of this job.",
        alias="additionalStatusInformation",
    )
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('INITIALIZED', 'WAITING_FOR_RESOURCES', 'RUNNING', 'STOPPED', 'SUCCEEDED', 'PARTIALLY_SUCCEEDED', 'FAILED')"
            )
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.additional_status_information is None
            and "additional_status_information" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "bundle": Bundle.from_dict(obj["bundle"])
