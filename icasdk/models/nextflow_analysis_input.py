...
class NextflowAnalysisInput(BaseModel):
    ...
    reference_data_parameters: Optional[
        List[Optional[AnalysisReferenceDataParameter]]
    ] = Field(default=None, alias="referenceDataParameters")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.reference_data_parameters is None
            and "reference_data_parameters" in self.model_fields_set
        ):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "inputs": [
                    AnalysisDataInput.from_dict(_item) for _item in obj["inputs"]
                ]
                if obj.get("inputs") is not None
                else None,
                "parameters": [
                    AnalysisParameterInput.from_dict(_item)
                    for _item in obj["parameters"]
                ]
                if obj.get("parameters") is not None
                else None,
                "referenceDataParameters": [
                    AnalysisReferenceDataParameter.from_dict(_item)
                    for _item in obj["referenceDataParameters"]
                ]
                if obj.get("referenceDataParameters") is not None
                else None,
            }
        )
        return _obj
