...
class AnalysisV3(BaseModel):
    ...
    pipeline: PipelineV3
    workflow_session: Optional[WorkflowSessionV3] = Field(
    ...
    analysis_storage: Optional[AnalysisStorageV3] = Field(
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('REQUESTED', 'AWAITINGINPUT', 'INPROGRESS', 'SUCCEEDED', 'FAILED', 'FAILEDFINAL', 'ABORTED')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "pipeline": PipelineV3.from_dict(obj["pipeline"])
                if obj.get("pipeline") is not None
                else None,
                "workflowSession": WorkflowSessionV3.from_dict(obj["workflowSession"])
