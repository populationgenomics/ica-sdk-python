...
class Bundle(BaseModel):
    ...
    ] = Field(alias="releaseVersion")
    version_comment: Optional[
        Annotated[str, Field(min_length=1, strict=True, max_length=4000)]
    ] = Field(default=None, alias="versionComment")
    status: StrictStr
    categories: Optional[List[Optional[StrictStr]]] = Field(
        default=None, description="category tags as string array"
    )
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(["DRAFT", "RELEASED", "DEPRECATED"]):
            raise ValueError(
                "must be one of enum values ('DRAFT', 'RELEASED', 'DEPRECATED')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "links": Links.from_dict(obj["links"])
