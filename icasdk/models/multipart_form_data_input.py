...
class MultipartFormDataInput(BaseModel):
    ...
    form_data_map: Optional[Dict[str, List[InputPart]]] = Field(
        default=None, alias="formDataMap"
    )
    ...
    __properties: ClassVar[List[str]] = ["formDataMap", "formData", "preamble", "parts"]
            ...
            for _key_form_data_map in self.form_data_map:
                if self.form_data_map[_key_form_data_map] is not None:
                    _field_dict_of_array[_key_form_data_map] = [
                        _item.to_dict()
                        for _item in self.form_data_map[_key_form_data_map]
                    ]
        ...
        if self.form_data:
            for _key_form_data in self.form_data:
                if self.form_data[_key_form_data]:
                    _field_dict[_key_form_data] = self.form_data[
                        _key_form_data
                    ].to_dict()
        ...
        _obj = cls.model_validate(
            {
                ...
                "formData": dict(
                    (_k, InputPart.from_dict(_v)) for _k, _v in obj["formData"].items()
                )
                if obj.get("formData") is not None
                else None,
                "preamble": obj.get("preamble"),
                "parts": [InputPart.from_dict(_item) for _item in obj["parts"]]
