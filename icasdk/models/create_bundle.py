...
class CreateBundle(BaseModel):
    ...
    bundle_version_comment: Optional[StrictStr] = Field(
        default=None, alias="bundleVersionComment"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.bundle_version_comment is None
            and "bundle_version_comment" in self.model_fields_set
        ):
