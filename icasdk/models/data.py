...
class Data(BaseModel):
    ...
    urn: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2000)]] = (
        Field(
            default=None,
            description="The URN of this data. The format is urn:ilmn:ica:region:\\<ID of the region\\>:data:\\<ID of the data\\>#\\<optional data path\\>. The path can be omitted, in that case the hashtag (#) must also be omitted.",
        )
    )
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "urn": obj.get("urn"),
                "details": DataDetails.from_dict(obj["details"])
                if obj.get("details") is not None
                else None,
                "folderDetails": FolderDetails.from_dict(obj["folderDetails"])
                if obj.get("folderDetails") is not None
                else None,
            }
        )
        return _obj
