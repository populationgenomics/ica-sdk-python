...
class InputFormFieldValues(BaseModel):
    ...
    id: StrictStr
    values: Optional[List[Optional[StrictStr]]] = Field(
        default=None,
        description="Use 'values' for all fields except data fields. Use string values to avoid rounding of numbers with a high precision. '' values for textbox type fields will be treated as null.",
    )
    data_values: Optional[List[Optional[InputFormData]]] = Field(
        default=None,
        description="Use 'dataValues' for data fields.",
        alias="dataValues",
    )
    external_data_values: Optional[List[Optional[AnalysisInputExternalData]]] = Field(
        default=None,
        description="Use 'externalDataValues' for external data",
        alias="externalDataValues",
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.external_data_values is None
            and "external_data_values" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "dataValues": [
                    InputFormData.from_dict(_item) for _item in obj["dataValues"]
                ]
                if obj.get("dataValues") is not None
                else None,
                "externalDataValues": [
                    AnalysisInputExternalData.from_dict(_item)
                    for _item in obj["externalDataValues"]
                ]
                if obj.get("externalDataValues") is not None
                else None,
            }
        )
        return _obj
