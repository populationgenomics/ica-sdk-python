...
class AnalysisData(BaseModel):
    ...
    mount_path: Optional[StrictStr] = Field(
        default=None,
        description="The requested location where the input file was located on the machine that was running the pipeline.",
        alias="mountPath",
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "children": [AnalysisData.from_dict(_item) for _item in obj["children"]]
