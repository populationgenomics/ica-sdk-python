...
class User(BaseModel):
    ...
    job_title: Optional[
        Annotated[str, Field(min_length=0, strict=True, max_length=255)]
    ] = Field(default=None, alias="jobTitle")
    greeting: Optional[StrictStr] = None
    mobile_phone_number: Optional[
        Annotated[str, Field(min_length=0, strict=True, max_length=255)]
    ] = Field(default=None, alias="mobilePhoneNumber")
    phone_number: Optional[
        Annotated[str, Field(min_length=0, strict=True, max_length=255)]
    ] = Field(default=None, alias="phoneNumber")
    fax_number: Optional[
        Annotated[str, Field(min_length=0, strict=True, max_length=255)]
    ] = Field(default=None, alias="faxNumber")
    ...
    address_line3: Optional[
        Annotated[str, Field(min_length=0, strict=True, max_length=255)]
    ] = Field(default=None, alias="addressLine3")
    postal_code: Optional[
        Annotated[str, Field(min_length=0, strict=True, max_length=255)]
    ] = Field(default=None, alias="postalCode")
    city: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]] = (
        None
    )
    state: Optional[
        Annotated[str, Field(min_length=0, strict=True, max_length=255)]
    ...
    def greeting_validate_enum(cls, value):
        ...
        if value not in set(["MR", "MRS", "MS", "MISS", "DR", "HR", "SR"]):
            raise ValueError(
                "must be one of enum values ('MR', 'MRS', 'MS', 'MISS', 'DR', 'HR', 'SR')"
            )
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.mobile_phone_number is None
            and "mobile_phone_number" in self.model_fields_set
        ):
