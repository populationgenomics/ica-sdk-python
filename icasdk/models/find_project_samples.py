...
class FindProjectSamples(BaseModel):
    ...
    conditions: List[FindSampleCondition] = Field(
        description="Adds a condition on a string field."
    )
    date_conditions: List[FindSampleDateCondition] = Field(
        description="Adds a condition on a date metadate field. If both the dateBefore and dateAfter parameter are null it will return any sample that has no value for the date field.",
        alias="dateConditions",
    )
    number_conditions: List[FindSampleNumberCondition] = Field(
        description="Adds a condition on a number metadata field. If both the lowerBoundary and upperBoundary parameter are null it will return any sample that has no value for the number field.",
        alias="numberConditions",
    )
    boolean_conditions: List[FindSampleBooleanCondition] = Field(
        description="Adds a condition on a boolean field.", alias="booleanConditions"
    )
    full_text_search_string: Optional[StrictStr] = Field(
        default=None,
        description="Adds a fuzzy matching condition for the text on all string fields of the sample i.e. on both the fixed fields (name, description) as any metadata text field.",
        alias="fullTextSearchString",
    )
    include_deleted: Optional[StrictBool] = Field(
        default=False,
        description="Indicates whether deleted samples should be included.",
        alias="includeDeleted",
    )
    user_tags: Optional[List[Optional[StrictStr]]] = Field(
        default=None,
        description="The usertags to filter on. The userTagMatchMode-parameter determines how the filtering is done.",
        alias="userTags",
    )
    user_tag_match_mode: Optional[StrictStr] = Field(
        default=None,
        description="How the usertags are filtered.",
        alias="userTagMatchMode",
    )
    run_input_tags: Optional[List[Optional[StrictStr]]] = Field(
        default=None,
        description="The runInputTags to filter on. The runInputTagMatchMode-parameter determines how the filtering is done.",
        alias="runInputTags",
    )
    run_input_tag_match_mode: Optional[StrictStr] = Field(
        default=None,
        description="How the runInputTags are filtered.",
        alias="runInputTagMatchMode",
    )
    connector_tags: Optional[List[Optional[StrictStr]]] = Field(
        default=None,
        description="The connectorTags to filter on. The connectorTagMatchMode-parameter determines how the filtering is done.",
        alias="connectorTags",
    )
    connector_tag_match_mode: Optional[StrictStr] = Field(
        default=None,
        description="How the connectorTags are filtered.",
        alias="connectorTagMatchMode",
    )
    tech_tags: Optional[List[Optional[StrictStr]]] = Field(
        default=None,
        description="The technicalTags to filter on. The techTagMatchMode-parameter determines how the filtering is done.",
        alias="techTags",
    )
    tech_tag_match_mode: Optional[StrictStr] = Field(
        default=None,
        description="How the technicalTags are filtered.",
        alias="techTagMatchMode",
    )
    instrument_run_ids: Optional[List[Optional[StrictStr]]] = Field(
        default=None, alias="instrumentRunIds"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if (
            self.full_text_search_string is None
            and "full_text_search_string" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.user_tag_match_mode is None
            and "user_tag_match_mode" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.run_input_tag_match_mode is None
            and "run_input_tag_match_mode" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.connector_tag_match_mode is None
            and "connector_tag_match_mode" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.tech_tag_match_mode is None
            and "tech_tag_match_mode" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.instrument_run_ids is None
            and "instrument_run_ids" in self.model_fields_set
        ):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "conditions": [
                    FindSampleCondition.from_dict(_item) for _item in obj["conditions"]
                ]
                if obj.get("conditions") is not None
                else None,
                "dateConditions": [
                    FindSampleDateCondition.from_dict(_item)
                    for _item in obj["dateConditions"]
                ]
                if obj.get("dateConditions") is not None
                else None,
                "numberConditions": [
                    FindSampleNumberCondition.from_dict(_item)
                    for _item in obj["numberConditions"]
                ]
                if obj.get("numberConditions") is not None
                else None,
                "booleanConditions": [
                    FindSampleBooleanCondition.from_dict(_item)
                    for _item in obj["booleanConditions"]
                ]
                if obj.get("booleanConditions") is not None
                else None,
                "fullTextSearchString": obj.get("fullTextSearchString"),
                "includeDeleted": obj.get("includeDeleted")
                if obj.get("includeDeleted") is not None
                else False,
