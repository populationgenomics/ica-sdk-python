...
class StorageConfigurationWithDetails(BaseModel):
    ...
    ] = Field(default=None, description="An optional description")
    type: StrictStr
    status: StrictStr
    error_message: Optional[
        ...
        default=None,
        description="An optional error message when something went wrong with the configuration",
        alias="errorMessage",
    )
    region: Region
    ...
    storage_configuration_details: StorageConfigurationDetails = Field(
        alias="storageConfigurationDetails"
    )
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(["INITIALIZING", "OK", "ERROR"]):
            raise ValueError(
                "must be one of enum values ('INITIALIZING', 'OK', 'ERROR')"
            )
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.storage_configuration_details:
            _dict["storageConfigurationDetails"] = (
                self.storage_configuration_details.to_dict()
            )
        ...
        _obj = cls.model_validate(
            {
                ...
                "storageConfigurationDetails": StorageConfigurationDetails.from_dict(
                    obj["storageConfigurationDetails"]
                )
                if obj.get("storageConfigurationDetails") is not None
                else None,
            }
        )
        return _obj
