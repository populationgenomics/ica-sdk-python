...
class SampleCreationBatchSampleItem(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "request": SampleCreationBatchItemRequest.from_dict(obj["request"])
                if obj.get("request") is not None
                else None,
                "processing": SampleCreationBatchItemProcessing.from_dict(
                    obj["processing"]
                )
                if obj.get("processing") is not None
                else None,
                "createdSample": Sample.from_dict(obj["createdSample"])
                if obj.get("createdSample") is not None
                else None,
            }
        )
        return _obj
