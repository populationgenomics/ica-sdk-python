        ...
        _obj = cls.model_validate(
            {
                ...
                "licenses": [Link.from_dict(_item) for _item in obj["licenses"]]
                if obj.get("licenses") is not None
                else None,
                "homepages": [Link.from_dict(_item) for _item in obj["homepages"]]
                if obj.get("homepages") is not None
                else None,
                "publications": [Link.from_dict(_item) for _item in obj["publications"]]
