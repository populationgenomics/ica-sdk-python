...
class CreateStorageConfiguration(BaseModel):
    ...
    name: Annotated[str, Field(min_length=3, strict=True, max_length=15)] = Field(
    ...
    storage_credential_id: UUID = Field(
        description="The id of the storage credential", alias="storageCredentialId"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "type": obj.get("type"),
                "awsDetails": AWSDetails.from_dict(obj["awsDetails"])
                if obj.get("awsDetails") is not None
                else None,
