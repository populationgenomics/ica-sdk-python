...
class CreateProjectDataCopyBatch(BaseModel):
    ...
    destination_folder_id: Optional[StrictStr] = Field(
        default=None, alias="destinationFolderId"
    )
    ...
    action_on_exist: Annotated[str, Field(strict=True)] = Field(
        description="only applicable on files, not on folders", alias="actionOnExist"
    )
    ...
    def action_on_exist_validate_regular_expression(cls, value):
        ...
        if not re.match(r"OVERWRITE|SKIP|RENAME", value):
            raise ValueError(
                r"must validate the regular expression /OVERWRITE|SKIP|RENAME/"
            )
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "items": [
                    CreateProjectDataCopyBatchItem.from_dict(_item)
