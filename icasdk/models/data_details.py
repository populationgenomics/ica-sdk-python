...
class DataDetails(BaseModel):
    ...
    owning_project_name: Optional[StrictStr] = Field(
        default=None, alias="owningProjectName"
    )
    name: StrictStr = Field(
        description="The name of the file/folder as it was uploaded."
    )
    path: Optional[StrictStr] = Field(
        default=None, description="The user friendly path of the parent of this data."
    )
    file_size_in_bytes: Optional[StrictInt] = Field(
        default=None,
    ...
    object_e_tag: Optional[StrictStr] = Field(
        default=None,
        description="The file's ETag, as received from the cloud provider. Not to be confused with the ETag reponse header of this API.",
        alias="objectETag",
    )
    stored_for_the_first_time_at: Optional[datetime] = Field(
        default=None,
        description="Specifies when the data object was stored for the first time",
        alias="storedForTheFirstTimeAt",
    )
    region: Optional[Region] = None
    application: Optional[ApplicationV4] = None
    will_be_archived_at: Optional[datetime] = Field(
        default=None,
        description="Specifies when the data object will be archived.",
        alias="willBeArchivedAt",
    )
    will_be_deleted_at: Optional[datetime] = Field(
        default=None,
        description="Specifies when the data object will be deleted.",
        alias="willBeDeletedAt",
    )
    ...
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(
            ["PARTIAL", "AVAILABLE", "ARCHIVING", "ARCHIVED", "UNARCHIVING", "DELETING"]
        ):
            raise ValueError(
                "must be one of enum values ('PARTIAL', 'AVAILABLE', 'ARCHIVING', 'ARCHIVED', 'UNARCHIVING', 'DELETING')"
            )
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.owning_project_name is None
            and "owning_project_name" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.file_size_in_bytes is None
            and "file_size_in_bytes" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.stored_for_the_first_time_at is None
            and "stored_for_the_first_time_at" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.will_be_archived_at is None
            and "will_be_archived_at" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.will_be_deleted_at is None
            and "will_be_deleted_at" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "tags": DataTag.from_dict(obj["tags"])
                if obj.get("tags") is not None
                else None,
                "format": DataFormat.from_dict(obj["format"])
                ...
                "sequencingRun": SequencingRun.from_dict(obj["sequencingRun"])
                if obj.get("sequencingRun") is not None
                else None,
            }
        )
        return _obj
