...
class AnalysisCreationBatchItemV3(BaseModel):
    ...
    created_analysis: Optional[AnalysisV3] = Field(
        default=None, alias="createdAnalysis"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "request": AnalysisCreationBatchItemRequest.from_dict(obj["request"])
                if obj.get("request") is not None
                else None,
                "processing": AnalysisCreationBatchItemProcessing.from_dict(
                    obj["processing"]
                )
                if obj.get("processing") is not None
                else None,
                "createdAnalysis": AnalysisV3.from_dict(obj["createdAnalysis"])
                if obj.get("createdAnalysis") is not None
                else None,
            }
        )
        return _obj
