...
class UpdateMetadata(BaseModel):
    ...
    update_single_metadata_fields: Optional[List[UpdateSingleMetadataField]] = Field(
        default=None,
        description="List of metadata fields to be updated",
        alias="updateSingleMetadataFields",
    )
    update_metadata_field_groups: Optional[List[Optional[UpdateMetadataFieldGroup]]] = (
        Field(
            default=None,
            description="List of metadata field groups to be updated",
            alias="updateMetadataFieldGroups",
        )
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.update_single_metadata_fields:
            for (
                _item_update_single_metadata_fields
            ) in self.update_single_metadata_fields:
        ...
        if (
            self.update_single_metadata_fields is None
            and "update_single_metadata_fields" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.update_metadata_field_groups is None
            and "update_metadata_field_groups" in self.model_fields_set
        ):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "updateSingleMetadataFields": [
                    UpdateSingleMetadataField.from_dict(_item)
                    for _item in obj["updateSingleMetadataFields"]
                ]
                if obj.get("updateSingleMetadataFields") is not None
                else None,
                "updateMetadataFieldGroups": [
                    UpdateMetadataFieldGroup.from_dict(_item)
                    for _item in obj["updateMetadataFieldGroups"]
                ]
                if obj.get("updateMetadataFieldGroups") is not None
                else None,
            }
        )
        return _obj
