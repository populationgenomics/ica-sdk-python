...
class CreateProject(BaseModel):
    ...
    project_owner_id: Optional[UUID] = Field(
        default=None,
        description="Owner of the project. Defaults to the current user.",
        alias="projectOwnerId",
    )
    region_id: UUID = Field(
        description="The region of the project. All data and pipeline executions will reside in this region.",
        alias="regionId",
    )
    ...
    data_sharing_enabled: StrictBool = Field(
    ...
    storage_configuration_id: Optional[UUID] = Field(
        ...
        alias="storageConfigurationId",
    )
    storage_configuration_subfolder: Optional[StrictStr] = Field(
        default=None,
        description="An optional subfolder that determines the object prefix of your self managed storage.  If not used, you will not be able to use this storage configuration for any future projects.",
        alias="storageConfigurationSubfolder",
    )
    analysis_priority: Optional[StrictStr] = Field(
        default="MEDIUM",
        description="Indicates the priority given to a project and its analyses within a single tenant, where MEDIUM is the default value.",
    ...
    def name_validate_regular_expression(cls, value):
        ...
        if not re.match(r"[a-zA-Z][a-zA-Z0-9_\s-]*", value):
            raise ValueError(
                r"must validate the regular expression /[a-zA-Z][a-zA-Z0-9_\s-]*/"
            )
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.project_owner_id is None
            and "project_owner_id" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.metadata_model_id is None
            and "metadata_model_id" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.storage_configuration_id is None
            and "storage_configuration_id" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.storage_configuration_subfolder is None
            and "storage_configuration_subfolder" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "storageConfigurationSubfolder": obj.get(
                    "storageConfigurationSubfolder"
                ),
                "analysisPriority": obj.get("analysisPriority")
                if obj.get("analysisPriority") is not None
                else "MEDIUM",
            }
        )
        return _obj
