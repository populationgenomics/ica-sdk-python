...
class WorkflowSessionInput(BaseModel):
    ...
    analysis_data: Optional[List[Optional[WorkflowSessionData]]] = Field(
        default=None,
        description="The workflow-session-data used as input by the workflow session.",
        alias="analysisData",
    )
    external_data: Optional[List[Optional[WorkflowSessionExternalData]]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                "code": obj.get("code"),
                "analysisData": [
                    WorkflowSessionData.from_dict(_item)
                    for _item in obj["analysisData"]
                ]
                if obj.get("analysisData") is not None
                else None,
                "externalData": [
                    WorkflowSessionExternalData.from_dict(_item)
