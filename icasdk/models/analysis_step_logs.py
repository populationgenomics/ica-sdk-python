...
class AnalysisStepLogs(BaseModel):
    ...
    std_out_stream: Optional[StrictStr] = Field(
        default=None,
        description="A WebSocket URL for reading the standard output log stream. Might be closed by ICA as soon as the analysis step execution has finished.",
        alias="stdOutStream",
    )
    std_err_data: Optional[Data] = Field(default=None, alias="stdErrData")
    std_err_stream: Optional[StrictStr] = Field(
        default=None,
        description="A WebSocket URL for reading the standard error log stream. Might be closed by ICA as soon as the analysis step execution has finished.",
        alias="stdErrStream",
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "stdOutData": Data.from_dict(obj["stdOutData"])
                if obj.get("stdOutData") is not None
                else None,
                "stdOutStream": obj.get("stdOutStream"),
                "stdErrData": Data.from_dict(obj["stdErrData"])
                if obj.get("stdErrData") is not None
                else None,
