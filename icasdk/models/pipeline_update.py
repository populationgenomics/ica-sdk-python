...
class PipelineUpdate(BaseModel):
    ...
    code: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = (
        Field(default=None, description="The code of the pipeline")
    )
    description: Optional[
        Annotated[str, Field(min_length=1, strict=True, max_length=4000)]
    ] = Field(default=None, description="The description of the pipeline")
    language_version: Optional[
        Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    ] = Field(
        default=None,
        description="Version of the pipeline language ",
