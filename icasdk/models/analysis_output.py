...
class AnalysisOutput(BaseModel):
    ...
    project_id: Optional[UUID] = Field(
        default=None,
        description="The ID of the project containing the analysis-data produced by the analysis for the output-parameter.",
        alias="projectId",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "data": [AnalysisData.from_dict(_item) for _item in obj["data"]]
