...
class EventLogV4(BaseModel):
    ...
    description: Annotated[str, Field(min_length=1, strict=True, max_length=1000)] = (
        Field(description="The details of the event")
    )
    event_type_category: Annotated[str, Field(strict=True)] = Field(
        description="The type of the event", alias="eventTypeCategory"
    )
