...
class ProjectDataLinkingBatchItemV4(BaseModel):
    ...
    created_project_data: Optional[ProjectData] = Field(
        default=None, alias="createdProjectData"
    )
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "id": obj.get("id"),
                "request": ProjectDataLinkingBatchItemRequest.from_dict(obj["request"])
                if obj.get("request") is not None
                else None,
                "processing": ProjectDataLinkingBatchItemProcessingV4.from_dict(
                    obj["processing"]
                )
                if obj.get("processing") is not None
                else None,
                "createdProjectData": ProjectData.from_dict(obj["createdProjectData"])
                if obj.get("createdProjectData") is not None
                else None,
            }
        )
        return _obj
