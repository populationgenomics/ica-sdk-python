...
class CWLToolDefinition(BaseModel):
    ...
    ] = Field(default=None, description="Description of the tool definition")
    ...
    version_comment: Optional[
        ...
        alias="versionComment",
    )
    release_version: Optional[StrictInt] = Field(
        default=None,
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(
            ...
            raise ValueError(
                "must be one of enum values ('DRAFT', 'RELEASED', 'DEPRECATED', 'RELEASECANDIDATE', 'BUILDING', 'BUILDFAILED')"
            )
        return value
        ...
        _obj = cls.model_validate(
            {
                ...
                "links": Link.from_dict(obj["links"])
