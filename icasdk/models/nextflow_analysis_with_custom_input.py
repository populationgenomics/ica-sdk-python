...
class NextflowAnalysisWithCustomInput(BaseModel):
    ...
    custom_input: StrictStr = Field(
        description="Contains the custom input, in YAML format or as an escaped JSON string.",
        alias="customInput",
    )
    ...
    external_data: Optional[List[Optional[AnalysisInputExternalData]]] = Field(
        default=None, alias="externalData"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "mounts": [
                    AnalysisInputDataMount.from_dict(_item) for _item in obj["mounts"]
                ]
                if obj.get("mounts") is not None
                else None,
                "externalData": [
                    AnalysisInputExternalData.from_dict(_item)
                    for _item in obj["externalData"]
                ]
                if obj.get("externalData") is not None
                else None,
            }
        )
        return _obj
