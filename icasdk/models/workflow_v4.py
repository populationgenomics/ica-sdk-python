...
class WorkflowV4(BaseModel):
    ...
    urn: Annotated[str, Field(min_length=1, strict=True, max_length=2000)] = Field(
        description="The URN of the workflow. The format is urn:ilmn:ica:\\<type of the object\\>:\\<ID of the object\\>#\\<optional human readable hint representing the object\\>. The hint can be omitted, in that case the hashtag (#) must also be omitted."
    )
    description: Annotated[str, Field(min_length=1, strict=True, max_length=4000)] = (
        Field(description="The description of the workflow")
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "workflowTags": PipelineTag.from_dict(obj["workflowTags"])
                if obj.get("workflowTags") is not None
                else None,
