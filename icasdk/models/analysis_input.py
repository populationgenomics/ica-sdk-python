...
class AnalysisInput(BaseModel):
    ...
    analysis_data: Optional[List[AnalysisData]] = Field(
        default=None,
        description="The analysis-data used as input by the analysis.",
        alias="analysisData",
    )
    external_data: Optional[List[Optional[AnalysisExternalData]]] = Field(
        default=None,
        ...
        _obj = cls.model_validate(
            {
                "code": obj.get("code"),
                "analysisData": [
                    AnalysisData.from_dict(_item) for _item in obj["analysisData"]
                ]
                if obj.get("analysisData") is not None
                else None,
                "externalData": [
                    AnalysisExternalData.from_dict(_item)
