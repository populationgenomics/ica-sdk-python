...
class WorkflowSessionData(BaseModel):
    ...
    data_id: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(
        description="The id of the file/folder.", alias="dataId"
    )
    format: Optional[DataFormat]
    name: StrictStr = Field(
        description="The name of the file/folder as it was processed by the workflow session."
    )
    data_type: StrictStr = Field(alias="dataType")
    mount_path: Optional[StrictStr] = Field(
        default=None,
        description="The requested location where the input file was located on the machine that was running the workflow.",
        alias="mountPath",
    )
