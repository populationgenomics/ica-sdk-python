...
class ReferenceData(BaseModel):
    ...
    version: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(
        ...
        _obj = cls.model_validate(
            {
                ...
                "name": obj.get("name"),
                "species": Species.from_dict(obj["species"])
                if obj.get("species") is not None
                else None,
                "dataFormat": DataFormat.from_dict(obj["dataFormat"])
                if obj.get("dataFormat") is not None
                else None,
                "version": obj.get("version"),
                "typeList": ReferenceDataTypeList.from_dict(obj["typeList"])
                if obj.get("typeList") is not None
                else None,
            }
        )
        return _obj
