...
class AnalysisReportEntry(BaseModel):
    ...
    report_title: Optional[StrictStr] = Field(
        default=None, description="The name of the report config", alias="reportTitle"
    )
    report_data: Optional[List[Optional[AnalysisReportData]]] = Field(
        default=None,
        description="The list of analysis report files",
        alias="reportData",
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "reportData": [
                    AnalysisReportData.from_dict(_item) for _item in obj["reportData"]
                ]
