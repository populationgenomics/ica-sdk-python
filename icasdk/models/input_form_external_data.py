...
class InputFormExternalData(BaseModel):
    ...
    s3_details: Optional[InputFormS3DataDetails] = Field(
        default=None, alias="s3Details"
    )
    basespace_details: Optional[InputFormBaseSpaceDataDetails] = Field(
        ...
        _obj = cls.model_validate(
            {
                "url": obj.get("url"),
                "type": obj.get("type"),
                "s3Details": InputFormS3DataDetails.from_dict(obj["s3Details"])
                if obj.get("s3Details") is not None
                else None,
                "basespaceDetails": InputFormBaseSpaceDataDetails.from_dict(
