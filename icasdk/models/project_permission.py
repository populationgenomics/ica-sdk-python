...
class ProjectPermission(BaseModel):
    ...
    def role_project_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(
            ["NONE", "VIEWER", "CONTRIBUTOR", "ADMINISTRATOR", "DATA_PROVIDER"]
        ):
            raise ValueError(
                "must be one of enum values ('NONE', 'VIEWER', 'CONTRIBUTOR', 'ADMINISTRATOR', 'DATA_PROVIDER')"
            )
        return value
    ...
    def role_flow_validate_enum(cls, value):
        ...
        if value not in set(["NONE", "VIEWER", "CONTRIBUTOR"]):
            raise ValueError(
                "must be one of enum values ('NONE', 'VIEWER', 'CONTRIBUTOR')"
            )
        return value
