...
class CreateFileAndTemporaryCredentials(BaseModel):
    ...
    folder_id: Optional[StrictStr] = Field(
        default=None,
        description="The id of the folder you want to create this new file in. Alternatively, the folderPath attribute could be used as well for this.",
        alias="folderId",
    )
    folder_path: Optional[Annotated[str, Field(strict=True)]] = Field(
        default=None,
        description="The absolute path of the folder you want to create this new file in which must end with '/'. Alternatively, the folderId attribute could be used as well for this. In case the folder path does not yet exist, it will be automatically created.",
        alias="folderPath",
    )
    format_code: Optional[StrictStr] = Field(
        default=None,
        description="The code of the format you would like to assign at creation time. If not specified, auto format assignment will be done.",
        alias="formatCode",
    )
