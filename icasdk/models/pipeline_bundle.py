...
class PipelineBundle(BaseModel):
    ...
    id: UUID
    name: StrictStr
    max_number_of_allowed_slots: Annotated[int, Field(strict=True, ge=-1)] = Field(
        alias="maxNumberOfAllowedSlots"
    )
        ...
        _obj = cls.model_validate(
            {
                ...
                "activePipelines": [
                    PipelineV3.from_dict(_item) for _item in obj["activePipelines"]
                ]
                if obj.get("activePipelines") is not None
                else None,
                "canceledPipelines": [
                    PipelineV3.from_dict(_item) for _item in obj["canceledPipelines"]
                ]
                if obj.get("canceledPipelines") is not None
                else None,
                "retiredPipelines": [
                    PipelineV3.from_dict(_item) for _item in obj["retiredPipelines"]
                ]
                if obj.get("retiredPipelines") is not None
                else None,
                "regions": [Region.from_dict(_item) for _item in obj["regions"]]
                if obj.get("regions") is not None
                else None,
                "analysisStorages": [
                    AnalysisStorageV3.from_dict(_item)
                    for _item in obj["analysisStorages"]
                ]
                if obj.get("analysisStorages") is not None
                else None,
            }
        )
        return _obj
