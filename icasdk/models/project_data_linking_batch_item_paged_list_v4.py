...
class ProjectDataLinkingBatchItemPagedListV4(BaseModel):
    ...
    next_page_token: Optional[
        Annotated[str, Field(min_length=0, strict=True, max_length=2000)]
    ] = Field(
        default=None,
        description="The cursor to request the next page. For offset-based paging the value is an empty string.",
        alias="nextPageToken",
    )
    remaining_records: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(
        default=None,
        description="The number of records remaining (used in cursor based pagination)",
        alias="remainingRecords",
    )
    total_item_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(
        default=None,
        description="The total number of records matching the search criteria (used in offset based pagination)",
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.remaining_records is None
            and "remaining_records" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.total_item_count is None
            and "total_item_count" in self.model_fields_set
        ):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {
                "items": [
                    ProjectDataLinkingBatchItemV4.from_dict(_item)
